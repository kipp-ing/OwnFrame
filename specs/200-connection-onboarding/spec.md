...
**Status**: Active — amended 2026-09-14 (#73: FR-200-24 password cleanup; landing screen open for Jan).
...
- **FR-200-24**: Reset MUST clear server URL, selected album, and the Keychain API key, then return onboarding to the combined connection step. *(Amended 2026-09-14, #73: Reset also clears the source library and deletes every saved link's Keychain password, per 120 FR-120-14. Where Reset should land — this connection step, or the welcome choice from 220 for people who set up with an Immich link or an iCloud album — is open for Jan, `docs/hitl.md` §2b.)*
